...
function showTable() {
    ...
    tables.forEach(function (table) {
        if (!table.classList.contains('always-active')) {
    ...
    cardContainers.forEach(function (container) {
        if (!container.id.includes('juegos')) { // Don't hide the always-active card container
            container.classList.remove('visible');
        }
    });
    ...
    // Always show always-active tables
    document.querySelectorAll('.table-wrapper.always-active').forEach(function (table) {
